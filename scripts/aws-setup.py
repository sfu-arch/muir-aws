""" This script configures your AWS account to run Dandelion. """

import boto3

vpcname = 'dandelion'
secgroupname = 'dandelion'
...
print("Creating VPC for Dandelion...")
...
print("Creating a security group for Dandelion...")
sec_group = ec2.create_security_group(
    GroupName=secgroupname, Description='dandelion security group', VpcId=vpc.id)
...
sec_group.authorize_ingress(IpPermissions=[
    ...
    {u'PrefixListIds': [], u'FromPort': 10000, u'IpRanges': [{u'Description': 'dandelion network model', u'CidrIp': '0.0.0.0/0'}], u'ToPort': 11000, u'IpProtocol': 'tcp', u'UserIdGroupPairs': [], u'Ipv6Ranges': [{u'Description': 'dandelion network model', u'CidrIpv6': '::/0'}]},
